...
// in triplanar mode (enabled below) can be easily adopted for voxel terrains
//
// (C) Tomasz Stobierski 2013-2016
//
//
Shader "Relief Pack - Standalone/Parallax Mapped Triplanar - PolyBrush" {
	...
	SubShader {
		...
		#pragma surface surf Standard vertex:vert finalcolor:customFog exclude_path:prepass fullforwardshadows 
		// U5 fog handling
