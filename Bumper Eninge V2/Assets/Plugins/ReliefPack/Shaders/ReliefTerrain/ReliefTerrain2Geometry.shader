...
SubShader {
	...
	//Offset -1,-1
	CGPROGRAM
	#pragma surface surf Standard vertex:vert finalcolor:customFog noinstancing exclude_path:prepass
	// U5 fog handling
...
ZTest LEqual	
CGPROGRAM
	#pragma surface surf Standard vertex:vert finalcolor:customFog decal:blend noinstancing exclude_path:prepass
	// U5 fog handling
	#pragma multi_compile_fog	
	#include "UnityCG.cginc"
	#pragma target 3.0
