Shader "Relief Pack - GeometryBlend/ Standard (Specular setup)"
{
	Properties
	{
		...
		// RTP - geom blend
		_TERRAIN_HeightMap ("Detail heightmaps", 2D) = "grey" {}
		_TERRAIN_Control ("Control tex", 2D) = "grey" {}
		_TERRAIN_PosSize ("Terrain pos (XY) size (ZW)", Vector) = (0,0,2000,2000)
		_TERRAIN_Tiling ("Terrain tiling (XY) offset (ZW)", Vector) = (1,1,0,0)
	}
