...
// 
Shader "Relief Pack - GeometryBlend/2 Layers/HeightBlend" {
    Properties {
		...
		//_uvBlendAmount ("UV blend amount", Float) = 0.5
		//_uvBlendSaturation ("UV blend saturation", Float) = 0.5
		
		//_VerticalTexture ("Vertical texture", 2D) = "grey" {}
		//_VerticalTextureTiling ("Vertical texture tiling", Float) = 30
		//_VerticalTextureStrengthA ("Vertical texture amount A", Float) = 0.5
		//_VerticalTextureStrengthB ("Vertical texture amount B", Float) = 0.5
		//_VerticalTextureGlobalBumpInfluence ("Vertical texture perlin distorion", Float) = 0.01
