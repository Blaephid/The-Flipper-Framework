//
// Relief Terrain  - 2 Parallax mapped materials with water - height blened (flowMap RG - first layer + GB - 2nd)
...
//
Shader "Relief Pack - GeometryBlend/Water/2 Layers/FlowMap - HeightBlend" {
    Properties {
		_Color("Color A", Color) = (0.5,0.5,0.5,1)	
		_MainTex("Albedo (A chan. - smoothness) A", 2D) = "white" {}
		...
		_MainTex2("Albedo (A chan. - smoothness) B", 2D) = "white" {}
