...
float2 RTP_CustomTiling;
	...
	UNITY_SETUP_INSTANCE_ID(v);
	...
	#if defined(UNITY_INSTANCING_MAPS) && !defined(TESSELLATION)
		...
		v.vertex.y = hm * _TerrainHeightmapScale.y; // will be overriden for tessellation (compiler is supposed to optimize this)
		v.vertex.w = 1.0f;

		v.texcoord.xy = sampleCoords;// (patchVertex.xy * uvscale.zw + uvoffset.zw);
		v.texcoord2 = v.texcoord1 = v.texcoord;

		// will be overriden for tessellation (compiler is supposed to optimize this)
