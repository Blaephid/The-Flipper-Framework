...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public Vector3 GetPointAtDistance (float dst, EndOfPathInstruction endOfPathInstruction = EndOfPathInstruction.end, GameObject Player = null) {
            float t = dst / length;
            return GetPointAtTime (t, endOfPathInstruction, Player);
        }
        ...
        public Vector3 GetPointAtTime (float t, EndOfPathInstruction endOfPathInstruction = EndOfPathInstruction.Loop, GameObject Player = null) {
            var data = CalculatePercentOnPathData (t, endOfPathInstruction, Player);
        ...
        TimeOnPathData CalculatePercentOnPathData (float t, EndOfPathInstruction endOfPathInstruction, GameObject Player = null) {
