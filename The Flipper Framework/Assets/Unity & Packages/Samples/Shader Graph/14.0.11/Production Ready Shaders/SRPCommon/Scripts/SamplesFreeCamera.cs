...
namespace UnityEngine.Rendering
{
	...
	public class SamplesFreeCamera : MonoBehaviour
	{
		...
		//private static string kVertical = "Vertical"; //Arrows used to switch Samples in the SamplesShowcase script
		//private static string kHorizontal = "Horizontal"; //Arrows used to switch Samples in the SamplesShowcase script
