Shader "0_SonicGT/CharacterShaderFade" {
	Properties {
	...
	SubShader {
		Tags {"Queue"="Transparent"	"RenderType"="Transparent"}	//"Queue"="Transparent"	"RenderType"="Transparent" }
		LOD 200
		...
		*/
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			float3 reflectedDir = texCUBE (_Cube, WorldReflectionVector (IN, o.Normal)).rgb * _Reflectivity * r.r;
            ...
            float fade = saturate((distanceFromCamera - _FadeMin) / _FadeMax);*/
			o.Alpha =clamp( _DifuseColor.a + (Centerrgb * _CenterColor.a),0,1);
