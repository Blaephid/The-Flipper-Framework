...
public class S_Data_HintRing : MonoBehaviour
{
	S_HintBox _hintbox;
	[TextArea(3, 20)]
	...
	void DotRotation () {
		...
		float Distance = S_S_MoreMathMethods.GetDistanceOfVectors(transform.position, LookTarget.position) - Mathf.Pow(MinDistance, 2);
