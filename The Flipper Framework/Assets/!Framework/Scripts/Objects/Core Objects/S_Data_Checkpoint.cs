...
[ExecuteInEditMode]
public class S_Data_Checkpoint : MonoBehaviour
{
    ...
    public float CheckpointHeight = 15, CheckpointLenght = 3;
    ...
    private void Update()
    {
        ...
        GetComponent<BoxCollider>().center = new Vector3(0, (CheckpointHeight * 0.5f) - 1, CheckpointLenght * 0.5f);
#endif
    }
